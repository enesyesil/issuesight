            ...
            <div className="flex flex-col gap-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Pre-created concepts you can reference in tutorials.
                    </p>
                </div>
                <div className="flex flex-col items-center justify-center min-h-[400px] border rounded-lg border-dashed p-8 text-center animate-in fade-in-50">
                    <div className="mx-auto flex max-w-[420px] flex-col items-center justify-center text-center">
                        ...
                        <p className="mb-4 mt-2 text-sm text-muted-foreground">
                            Concepts will appear here once the backend is set up.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {concepts.map((concept) => (
                    <Link key={concept.id} href={`/dashboard/concepts/${concept.slug}`} className="group">
