...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			conceptrelationship.Table: conceptrelationship.ValidColumn,
			githubissue.Table:         githubissue.ValidColumn,
			project.Table:             project.ValidColumn,
			projectconcept.Table:      projectconcept.ValidColumn,
			tutorial.Table:            tutorial.ValidColumn,
			tutorialconcept.Table:     tutorialconcept.ValidColumn,
			tutorialcontent.Table:     tutorialcontent.ValidColumn,
