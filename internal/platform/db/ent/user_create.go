...
func (_c *UserCreate) SetLastRequestedAt(v time.Time) *UserCreate {
	_c.mutation.SetLastRequestedAt(v)
	return _c
}

// SetNillableLastRequestedAt sets the "last_requested_at" field if the given value is not nil.
func (_c *UserCreate) SetNillableLastRequestedAt(v *time.Time) *UserCreate {
	if v != nil {
		_c.SetLastRequestedAt(*v)
	}
	return _c
}
...
func (_c *UserCreate) AddTutorialIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddTutorialIDs(ids...)
	return _c
}

// AddTutorials adds the "tutorials" edges to the Tutorial entity.
func (_c *UserCreate) AddTutorials(v ...*Tutorial) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.LastRequestedAt(); ok {
